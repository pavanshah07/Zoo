...
<?php
    if(isset($_POST['update_data'])){
        if(!empty($_POST['pname'])){
            ...
            $query = "update `product` set `pname`='$pname',`pimage`='$filename' where `id`='$id'";
...
<div class="container-fluid bg-light p-0 wow fadeIn" data-wow-delay="0.1s">
    ...
    <h1 class="text-center text-danger">Update Birds & Animals Picture.</h1>

    <form style="width: 50%; margin-top: 50px;" class="container" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label text-dark">Birds Or Animals Name</label>
            <input type="hidden" name="id" value="<?php echo $id ?>">
            <input type="text" class="form-control" id="pname" name="pname" value="<?php echo $pname ?>" aria-describedby="emailHelp">
        </div>

        <div class="mb-3">
            <label for="pimage" class="form-label text-dark">Change Image</label>
